...
@section('title', 'Crear Miembro del Equipo')
@section('page-title', 'Nuevo Miembro del Equipo')
        ...
        <form action="{{ route('admin.team.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="institution" value="{{ old('institution', 'Universidad Politécnica de Puebla') }}" 
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-gray-900 focus:ring focus:ring-gray-200">
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="url" name="orcid_url" value="{{ old('orcid_url') }}" 
                           placeholder="https://orcid.org/0000-0000-0000-0000"
                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-gray-900 focus:ring focus:ring-gray-200">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Researcher ID</label>
                    <input type="text" name="researcher_id" value="{{ old('researcher_id') }}" 
            ...
            <div>
                ...
                <textarea name="profile_body" rows="6" 
                          class="w-full rounded-md border-gray-300 shadow-sm focus:border-gray-900 focus:ring focus:ring-gray-200">{{ old('profile_body') }}</textarea>
            ...
            <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-1"></i> Guardar Miembro
                </button>
            </div>
        </form>
    </div>
